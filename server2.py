...
# Sliders
number_agent = UserSettableParameter("slider", "Number of pairs", 20, 1, 100, 1)
...
eggs_per_nest = UserSettableParameter("slider", "Eggs per nest", 1, 0, 10, 1)
# Graphs
